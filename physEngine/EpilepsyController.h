#ifndef EPILEPSYCONTROLLER_H
#define EPILEPSYCONTROLLER_H
#include "EpilepsyObject.h"
#include "EpilepsyRectangle.h"
#include "EpilepsySphere.h"

class EpilepsyController
{
private:
        EpObject **Obj;
...
public:
        EpilepsyController();
        EpilepsyController(int numberOfPrimitives,float HZ,float numberOfSeconds,bool isGravity,bool isDumping,float planecoef,float mu)
        {
        ...
        {
                Obj[primitiveCount++]=new EpilepsyRectangle(vecPosition,vecSize,vecDirection,Coefficient,1.f/HZ,Dentisty,MUCOEFFICIENT);
        }
        ...
        {
                Obj[primitiveCount++]=new EpilepsySphere(vecPosition,sphereRadius,vecDirection,Coefficient,1.f/HZ,Dentesty,MUCOEFFICIENT);
        }
